...
- **Configurable defaults**: Opinionated parameters have defaults but are overridable — `auto_escalate=False`, `additional_property=False`, `filter_outliers=True`, `property_type="F"`, yield thresholds, value range percentages.
