...
> Render inline SVG with automatic sanitization.
...
```python Fixed size theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
from prefab_ui.components import Svg
...
```json Svg theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
{
  "type": "Svg",
